...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      secondary:
        "bg-slate-700 hover:bg-slate-800 text-white shadow-sm focus:ring-slate-500",
      outline:
      ...
      ghost:
        "bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 focus:ring-slate-500",
    };
